...
one number "
			...
			<div class="why_chose pull-left">
				...
				<ul class="fa-ul">
					<li><i class="fa-li fa fa-angle-right"></i>24/7 Support</li>
					<li><i class="fa-li fa fa-angle-right"></i>Weather Forecasting</li>
					<li><i class="fa-li fa fa-angle-right"></i>Reliable Service
						Network</li>
					<li><i class="fa-li fa fa-angle-right"></i>One SMS service</li>
				</ul>
